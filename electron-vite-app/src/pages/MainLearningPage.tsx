...
function PokemonModel() {
  const gltf = useLoader(GLTFLoader, "/pokemon-models/Hy3D_textured_00020_.glb");
...
export default function MainLearningPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#f0f8ff] to-white font-[\'Noto Sans KR\']">
      {/* 상단 경험치바 */}
      ...
      <main className="flex-1 flex p-6 overflow-hidden  w-full">
        ...
        <div className="w-2/5 flex items-center justify-center pl-4">
          <div className="relative bg-white rounded-xl shadow p-4 max-w-sm">
            <div className="text-sm">
              안녕하세요! 저는 피카츄입니다. 무엇을 도와드릴까요?
            </div>
            <div className="absolute left-[-12px] top-1/2 -translate-y-1/2 w-0 h-0 border-t-8 border-b-8 border-r-8 border-transparent border-r-white"></div>
          </div>
        </div>
      </main>
      ...
      <footer className="input-area p-4">
        <div className="max-w-5xl mx-auto w-full">
          <div className="flex items-center bg-gray-100 rounded-full p-1">
            ...
            <input id="message-input" type="text" placeholder="메시지를 입력하세요..." className="flex-1 bg-transparent border-none focus:outline-none px-4 py-2" />
            <button className="p-2 rounded-full hover:bg-gray-200">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
              </svg>
            </button>
            <button id="send-button" className="bg-blue-500 text-white rounded-full p-2 ml-1 hover:bg-blue-600">
